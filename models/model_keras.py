...
def build_keras_model() -> Sequential:
    model = Sequential()
    model.add(Dense(2, activation='relu'))  # input_shape=(train_data.shape[1],)
...
def train_keras_model(model: Sequential, x_train: np.ndarray, y_train: np.ndarray, num_epochs=1,
